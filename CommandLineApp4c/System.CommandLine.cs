...
namespace System.CommandLine
{
    ...
    public class CliOption<T>
    {
        ...
        public CliOption(string name, char abbr) : this(name) => Aliases = new[] { abbr.ToString() };
        public CliOption(string name, IEnumerable<string> aliases) : this(name) => Aliases = aliases;
    }

    public class CliOption : CliOption<bool>
    {
        public CliOption(string name) : base(name) { }
        public CliOption(string name, char abbr) : base(name, abbr) { }
        public CliOption(string name, IEnumerable<string> aliases) : base(name, aliases) { }
    }
